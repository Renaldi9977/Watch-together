...
async function startServer() {
  ...
  // ✅ Headers agar browser izinkan akses mic/camera
  // NOTE: Cross-Origin-Embedder-Policy sengaja TIDAK dipasang karena memblokir YouTube iframe
  ...
  io.on("connection", (socket) => {
    ...
    // ✅ FIX: Pakai socket.to() bukan io.to() agar event tidak dikirim balik ke pengirim
