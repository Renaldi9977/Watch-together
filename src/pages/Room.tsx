...
export default function Room() {
  ...
  // ✅ FIX 1: Regex diperbaiki — support semua format YouTube URL
  const extractYouTubeId = (url: string) => {
    if (!url) return null;
    // Support: youtube.com/watch?v=, youtu.be/, youtube.com/embed/, youtube.com/shorts/, youtube.com/live/, m.youtube.com, music.youtube.com
    const regex =
  ...
  // ✅ FIX 2: handleUrlChange sekarang reset ke null saat input kosong
  ...
  // ✅ FIX 3: handleLoadVideo menggunakan extractYouTubeId langsung (bukan state isValidUrl)
  // dan mengirim URL dalam format bersih agar player tidak error
            ...
            <div className="bg-[#161c2d] border border-[#2e3c5a] shadow-lg rounded-[24px] p-4 flex flex-col gap-4">
              <div className="flex flex-row gap-3 items-center w-full">
                <div className="relative flex-1">
                  {/* ✅ FIX 4: Tambah onKeyDown Enter + border merah/hijau sesuai validasi */}
                  <input
                    type="text"
                    value={inputUrl}
                ...
                {/* ✅ FIX 5: Tombol LOAD di-disable jika URL tidak valid */}
                <button
                  onClick={handleLoadVideo}
                  disabled={!inputUrl.trim() || isValidUrl !== true || isLoadingVideo}
                    ...
                    const avatarContent = msg.avatar ? (
                      ...
                      >
                        <img
                          src={msg.avatar}
                          alt={msg.sender}
                          className="w-full h-full rounded-full object-cover bg-black/50 aspect-square"
                        />
                      </div>
                    ) : (
                      <div 
